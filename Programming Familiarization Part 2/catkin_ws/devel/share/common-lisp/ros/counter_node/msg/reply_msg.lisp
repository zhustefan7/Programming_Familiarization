...
(cl:defmethod cl:initialize-instance :after ((m <reply_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'reply_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name counter_node-msg:<reply_msg> is deprecated: use counter_node-msg:reply_msg instead.")))
